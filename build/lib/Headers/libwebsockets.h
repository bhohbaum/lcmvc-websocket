...
enum libwebsocket_callback_reasons {
	...
	LWS_CALLBACK_ADD_POLL_FD,			/* external poll() management support */
	LWS_CALLBACK_DEL_POLL_FD,			/* external poll() management support */
	LWS_CALLBACK_CHANGE_MODE_POLL_FD,	/* external poll() management support */
	LWS_CALLBACK_LOCK_POLL,				/* external poll() management support */
	LWS_CALLBACK_UNLOCK_POLL,			/* external poll() management support */
